...
public abstract class SwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public static class UnderlayButton {
        ...
        public void onDraw(Canvas c, RectF rect, int pos){
            ...
            Drawable d = ContextCompat.getDrawable(MyApplication.context, imageResId);
...
//        SwipeHelper swipeHelper = new SwipeHelper(getContext(), fragmentContactBinding.ContactListView) {
//            @Override
...
//                               Config.showLongToast("Replay " + pos);
//
//                            }
//                        }
//                ));
