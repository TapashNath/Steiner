...
public class ItemsSliderAdapter extends SliderViewAdapter<ItemsSliderAdapter.SliderAdapterVH> {

    private Context context;
    private List<SlideModel> mSliderItems = new ArrayList<>();

    public ItemsSliderAdapter(Context context, List<SlideModel> mSliderItems) {
